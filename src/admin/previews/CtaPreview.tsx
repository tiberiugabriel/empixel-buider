  ...
  return (
    <div style={{ ...theme, padding: "20px 16px", textAlign: "center" }}>
      <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 6 }}>
        {config.headline ? String(config.headline) : <span style={{ fontStyle: "italic", opacity: 0.5 }}>Headline...</span>}
      </div>
      {!!config.body && <div style={{ fontSize: 11, opacity: 0.8, marginBottom: 10 }}>{String(config.body).slice(0, 80)}</div>}
